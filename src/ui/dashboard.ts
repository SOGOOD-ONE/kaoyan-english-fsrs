    ...
    root.innerHTML = `
      <div class="dashboard-shell">
        <header class="dashboard-header">
          <div><div class="dashboard-brand">考研英语核心词</div><div class="dashboard-subtitle">FSRS-6 智能学习系统</div></div>
        ...
        <main>
          ...
          <section class="dashboard-actions">
            ...
            <a class="study-action ${reviewRequired ? "locked" : "primary"}" ${reviewRequired ? `href="/study/review" aria-disabled="true" data-locked="1"` : `href="/study/new"`}><span class="study-action-title">学习新词</span><span class="study-action-desc">${reviewRequired ? "完成今日复习后解锁" : `今天可学习 ${today.newQuota} 个新词`}</span><span class="study-action-arrow">${reviewRequired ? "🔒" : "→"}</span></a>
